                ...
                <div class="product-detail">
                    <div class="shop-product p-t-25">
                        ...
                        <div class="product-body">
                            ...
                            <?php } ?>
                            <span class="price"><?php echo number_format($product['selling_price'], 0, ',', '.') . " INR"; ?></span><br><br>
                            <div class="product-button">
                                <div class="quantity">
                                    <span class="sub">
                                        <i class="fa fa-angle-down"></i>
                                    </span>
                                    <input type="number" id="txtQty" name="quantity[<?php echo $product['product_id'] ?>]" value="1" min="1">
                                    <span class="add">
                                ...
                                <script type="text/javascript">
                                    function getQty() {
                                        ...
                                        var url = "cart.php?action=add&id=<?php echo $product['product_id'] ?>&qty=" + document.getElementById('txtQty').value;
                                        window.location.href = url;
                                    }
                                </script>
                                <a id="kypn" href='' onclick="getQty()" class="add-to-cart">Add to cart</a>
                            </div>
                            ...
                            ?>
                                <div class="col-md-12">
                                    <div class="grid-product">
                                        ...
                                        <div class="price"><?php echo number_format($product['selling_price'], 0, ',', '.') . " INR"; ?></div>
                                    </div>
                                </div>
                            <?php
                            }
