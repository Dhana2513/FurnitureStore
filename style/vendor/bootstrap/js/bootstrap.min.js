        ...
        R = (m = "button", E = "." + (v = "bs.button"), T = ".data-api", y = (p = e).fn[m], C = "active", I = "btn", A = "focus", b = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = "input", w = ".active", N = ".btn", O = {
            ...
            var e = "collapse", n = "bs.collapse", i = "." + n, o = t.fn[e], a = {toggle: !0, parent: ""},
                ...
                p = {ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, m = function () {
                    function i(e, n) {
                        this._isTransitioning = !1, this._element = e, this._config = this._getConfig(n), this._triggerArray = t.makeArray(t('[data-toggle="collapse"][href="style/#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
            ...
            var e = "scrollspy", n = "bs.scrollspy", i = "." + n, o = t.fn[e], a = {offset: 10, method: "auto", target: ""},
                ...
                c = "dropdown-item", u = "active", f = {
                    ...
                    return g.refresh = function () {
                        ...
                        n = n.map(function (t) {
                            return t + '[data-target="' + e + '"],' + t + '[href="style/' + e + '"]'
                        });
                        var i = t(n.join(","));
