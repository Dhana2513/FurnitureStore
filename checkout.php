                    ...
                    <div class="au-form-body">
                        <h2 class="au-form-title form-title-border m-b-37">Additional information</h2>
                            <div class="form-group au-form">
                                ...
                                <textarea cols="70" rows="9" name="add_notice" style="color: black;border: 1px solid #e5e5e5;font-size: 13px;padding: 10px 20px;" placeholder="For example, time or specific delivery location instructions."></textarea>
                            </div>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <table class="checkout-bill">
                            ...
                            while ($rows = mysqli_fetch_array($r,MYSQLI_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo number_format($subtotal, 0, ',', '.')."<span style='color: red'>INR</span>";?></td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td>30.000<span style="color:red;">INR</span></td>
                            </tr>
                            <tr class="total">
                                <td>TOTAL</td>
                                <td><?php echo number_format($total, 0, ',', '.')."<span style='color: red'>INR</span>";?></td>
                            </tr>
                            </tbody>
                        </table>
