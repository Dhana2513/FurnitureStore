    ...
    <div class="content-wrapper">
        ...
        <div class="row grid-margin">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center;font-size: 30px;">Add Slide</h4>
                        <form class="forms-sample" method="post" action="action/action_add_slide.php" enctype="multipart/form-data">


                            <div class="form-group">
                                <label>Choose a photo slide<span style="color: red">*</span></label>
                            ...
                            <input type="submit" class="btn btn-primary mr-2" name="submit" value="Add slides">
                        </form>
                    </div>
                </div>
            </div>
