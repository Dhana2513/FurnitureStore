                        ...
                        <form class="forms-sample" action="action/action_edit_role.php?rid=<?php echo $rid;?>" method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php if(isset($role['permission'])) echo $role['permission'];?>"
                                       name="permission" class="form-control" id="exampleInputEmail3" placeholder="Fill in the example permissions: add_category ..." />
                            </div>
                            <button type="submit" name="submit" class="btn btn-primary mr-2">Correction of position</button>
                        </form>
                    </div>
                </div>
            </div>
