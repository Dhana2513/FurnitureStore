            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Have everything <b><?php echo $total_record;?></b> position</p><br>
                                ...
                                <table class="jsgrid-table">
                                    ...
                                    while ($role = mysqli_fetch_array($r1, MYSQLI_ASSOC)) {
                                        ...
                                        if (has_permission($account,$permission)){
                                            if ($role['role'] != 'User'){
                                                echo "<a href='delete_role.php?rid={$role['role_id']}'><input class='jsgrid-button jsgrid-delete-button' type='button' title='Delete'></a>";
                                            }
                                        }
