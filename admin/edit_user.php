    ...
    <div class="content-wrapper">
        ...
        <div class="row grid-margin">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center;font-size: 30px;">Edit your account  : <?php if(isset($user['user_name'])) echo $user['user_name'];?></h4>
                        <form class="forms-sample" action="action/action_edit_user.php?uid=<?php echo $uid;?>" method="post" >
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail3">Account <span style="color: red">*</span></label>
                            ...
                            <button type="submit" name="submit" class="btn btn-primary mr-2">Edit account</button>
                        </form>
                    </div>
                </div>
            </div>
