    ...
    <div class="content-wrapper">
        <div class="row grid-margin">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center;font-size: 30px;">Remove transaction : <?php if (isset($transaction['customer_name'])) echo $transaction['customer_name'];?></h4>
                        <!-- Dummy Modal Starts -->
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Do you want to delete the transaction of <b><?php if (isset($transaction['customer_name'])) echo $transaction['customer_name'];?></b> ?</p>
                                        </div>
