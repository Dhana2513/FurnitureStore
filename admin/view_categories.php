    ...
    <div class="content-wrapper">
        ...
        <div class="row grid-margin">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center;font-size: 30px;">Danh sách các CATEGORY</h4>
                        <p>Có tất cả <b><?php echo $total_record;?></b> CATEGORY</p><br>
                                    ...
                                    <tr class="jsgrid-header-row">
                                        ...
                                        <th class="jsgrid-header-cell jsgrid-control-field jsgrid-align-center"
                                            style="width: 50px;"><a href="add_category.php"><input
                                                    ...
                                                    type="button" title="Thêm CATEGORY"></a></th>
                                    </tr>
                                </table>
                            </div>
