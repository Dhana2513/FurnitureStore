    ...
    <section>
        <div class="pageintro">
            ...
            <div class="pageintro-body">
                <h1 class="pageintro-title">Search</h1>
            </div>
        </div>
    </section>
    <section>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="shop-list">
                        ...
                        if (empty($search)) {
                            echo "Please enter the product data you want to search";
                        }
                        else
                        {
                        //Phan Trang
                        ...
                        echo "Find <b>$total_record</b> product with keywords <b>$search</b> <br><br>";
                        ?>
                                ...
                                <?php
                                    ...
                                    <div class="shop-product">
                                        <div class="product-image">
                                            <a href="#">
                                                ...
                                                if ($rows['selling_price']<$rows['product_price']){
                                                    ...
                                                    echo "
                                                        <span class=\"ribbons\">
                                                            <span class=\"onsale ribbon\">$discount% off</span>
                                                        </span>
                                                    ";
                                                }
                                                ?>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <p class="price"><?php echo number_format($rows['selling_price'], 0, ',', '.')." INR"?></p>
                                            <p class="description"><?php echo $rows['introduce']?></p>
                                            <div class="product-button">
                                                <a href="cart.php?action=add&id=<?php echo $rows['product_id']?>" class="add-to-cart">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                            <?php } ?>
                ...
                <?php
                    ...
                    echo "No products were found with the keyword <b>$search</b>!";
                }
                }
                }
                ?>
