                            ...
                            <table class="table-shop">
                                ...
                                while ($rows = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo number_format($rows['selling_price'], 0, ',', '.') . " INR" ?>
                                        </td>
                                        <td>
                                            <div class="quantity">
                                        <span class="sub">
                                        ...
                                        <td>
                                            ...
                                            echo number_format($Thanhtien, 0, ',', '.') . " INR";
                                            ?>
                                        </td>
                                        <td>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="table-shop-product">
                                            <div class="name" style="margin: auto;color: orangered">TOTAL
                                                : <?php echo number_format($totalprice, 0, ',', '.') . " INR"; ?></div>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
